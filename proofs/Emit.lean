...
def outputs : List (System.FilePath × Convex.Module) :=
  [ ("convex/generated/game-api.generated.ts", Convex.module),
    ...
    ("convex/generated/player.generated.ts", Backend.Player.module),
    ("convex/generated/shop.generated.ts", Backend.Shop.module),
    ("convex/generated/turn.generated.ts", Backend.Turn.module),
    ("convex/generated/encounter.generated.ts", Backend.Encounter.module),
    ("convex/generated/landing.generated.ts", Backend.Landing.module),
    ("convex/generated/camera.generated.ts", Backend.Camera.module),
    ("convex/generated/room.generated.ts", Backend.Room.Movement.module),
    ("convex/generated/combat/state.generated.ts", Backend.Combat.State.module),
    ("convex/generated/combat/attack.generated.ts", Backend.Combat.Attack.module),
    ("convex/generated/combat/guard.generated.ts", Backend.Combat.Guard.module),
    ("convex/events/validators.generated.ts", Game.Events.module),
    ("convex/events/router.generated.ts", Backend.Router.module),
